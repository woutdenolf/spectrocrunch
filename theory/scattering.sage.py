...
def thomson():
    ...
    It_scat = I_scat.substitute(a=(_sage_const_1 +cos(theta)**_sage_const_2 )/_sage_const_2 )
    
    print "\nScattered intensity (unpol):"
    print It_scat.substitute(S1=_sage_const_0 ).substitute(S2=_sage_const_0 ).simplify_full()
...
def compton():
    ...
    M1 = MuellerMatrixRotation(beta)
    M2 = matrix(SR,_sage_const_4 ,_sage_const_4 ,[a+c,_sage_const_1 -a,_sage_const_0 ,_sage_const_0 ,_sage_const_1 -a,a,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ,cos(theta),_sage_const_0 ,_sage_const_0 ,_sage_const_0 ,_sage_const_0 ,cos(theta)*(_sage_const_1 +c)])*s
    #print mueller_to_jones(M2)
    M2 = M2.substitute(theta = acos(sqrt(_sage_const_2 *a-_sage_const_1 ))).simplify()
    ...
    It_scat = It_scat.substitute(c=(E-Esc)/_sage_const_2 *(_sage_const_1 -cos(theta)))
    ...
    It_scatu2 = Esc**_sage_const_2 /E**_sage_const_2 *S0*(E/Esc+Esc/E-sin(theta)**_sage_const_2 )/_sage_const_2 
    ...
    It_scat = It_scat.substitute(Esc=E/(_sage_const_1 +E*(_sage_const_1 -cos(theta))))
    It_scat = It_scat.simplify_full()
    It_scat = definite_integral(It_scat*sin(theta),theta,_sage_const_0 ,pi)
    It_scat = definite_integral(It_scat,phi,_sage_const_0 ,_sage_const_2 *pi)
