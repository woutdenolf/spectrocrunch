...
BB = -_sage_const_2 *cos(delta)/(A**_sage_const_2 *sin(delta)**_sage_const_2  *sinbeta*cosbeta)

assert( AA*uxr**_sage_const_2  + BB*uxr*uyr + CC*uyr**_sage_const_2  == _sage_const_1 ) 

DD = sqrt((AA-CC)**_sage_const_2 +BB**_sage_const_2 )

semimajor = A*sqrt((_sage_const_1 +sqrt(_sage_const_1 -(sin2beta*sin(delta))**_sage_const_2 ))/_sage_const_2 )
semiminor = A*sqrt((_sage_const_1 -sqrt(_sage_const_1 -(sin2beta*sin(delta))**_sage_const_2 ))/_sage_const_2 )
